...
namespace Terminus.Infrastructure.Migrations
{
    ...
    [Migration("20260917115802_AddWaybillDeliverySnapshotAndItemPrice")]
    partial class AddWaybillDeliverySnapshotAndItemPrice
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Terminus.Domain.Entities.Contract", b =>
                {
                    ...
                    NpgsqlIndexBuilderExtensions.HasMethod(b.HasIndex("ContractNumber"), "gin");
                    NpgsqlIndexBuilderExtensions.HasOperators(b.HasIndex("ContractNumber"), new[] { "gin_trgm_ops" });
            ...
            modelBuilder.Entity("Terminus.Domain.Entities.Waybill", b =>
                {
                    ...
                    NpgsqlIndexBuilderExtensions.HasMethod(b.HasIndex("WaybillNumber"), "gin");
                    NpgsqlIndexBuilderExtensions.HasOperators(b.HasIndex("WaybillNumber"), new[] { "gin_trgm_ops" });
